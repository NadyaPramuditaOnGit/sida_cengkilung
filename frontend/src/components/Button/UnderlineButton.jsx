...
const buttonStyles = {
  ...
  states: {
    ...
    hover: "text-primary-shade1 border-primary-shade1 bg-transparent",
    pressed:
      "text-primary-shade4 border-primary-shade4 bg-gradient-to-b from-sky-500/20 to-blue-300/20",
    disabled:
      "text-primary-tint4 border-primary-tint4 cursor-not-allowed opacity-50",
  },
  textSizes: {
